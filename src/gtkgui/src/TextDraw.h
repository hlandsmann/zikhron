...
private:
    ...
    auto freshLayout() -> Glib::RefPtr<Pango::Layout>;
    auto sizeWithSpace(int width_or_height) const -> int;
    auto sizeNoSpace(int width_or_height) const -> int;
    ...
    auto calculateDrift(Glib::RefPtr<Pango::Layout>& layout) const -> int;
