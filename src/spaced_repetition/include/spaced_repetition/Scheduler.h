...
private:
    ...
    [[nodiscard]] auto nextInterval(double stability, double ease) const -> double;
    [[nodiscard]] auto nextIntervalDays(double stability, double ease) const -> std::chrono::days;
